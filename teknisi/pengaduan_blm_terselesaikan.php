    ...
    <div class="widget-content">
      ...
      <?php 
        ...
        $sql = mysqli_query($koneksi, "SELECT `kd_pengaduan`,`username`,`judul_permasalahan`,`deskripsi`,`tanggal_pengajuan`,`status`,`nama`,biro
                                              FROM pengaduan JOIN `user` USING (`username`) JOIN biro USING(`kd_biro`) WHERE status ='UnSolved' ORDER BY `tanggal_pengajuan` DESC;");
              ...
              <?php 
               ...
               <div class="btn-group">
                      ...
                      <ul class="dropdown-menu">
                        <li>
                          <a href="teknisi.php?page=edit_pengaduan&id=<?php echo $hasil['kd_pengaduan']; ?>&ket=belum"><i class="icon-check-sign"></i><?php echo $status_dropdwon; ?></a>
                        </li>
                      </ul>
                    </div>
            </div>

...
?>
 ...
 document.location='teknisi.php?page=list_pengaduan_blm_terselesaikan';
 </script>
 <?php 	
} elseif ($ket == "selesai") {
	?>
 <script language="JavaScript">
 document.location='teknisi.php?page=list_pengaduan_terselesaikan';
 </script>
 <?php 
}else{
?>
 <script language="JavaScript">
 document.location='teknisi.php?page=list_pengaduan';
 </script>
 <?php 
}
  ?>
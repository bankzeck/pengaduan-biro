  ...
  <div class="tab-content padded" id="my-tab-content">
    ...
    <div class="tab-pane" id="tab2">
      ...
      <p>
        ...
        <div class="form-group has-success">
              <label class="control-label" for="inputSuccess">Note Dari Kabiro</label>
              <input class="form-control" id="inputSuccess" type="text" value="<?php echo $hasil1['note_kabiro']; ?>" readonly="">
        </div>
        <div class="form-group has-success">
...
<a href="teknisi.php?page=list_pengaduan_semua"><button class="btn btn-lg btn-block btn-primary">Kembali</button></a>
</div>
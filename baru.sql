...
insert  into `bagian`(`kd_bagian`,`nama_bagian`,`kd_pic`) values ('1','IT','1'),('10','HRD','1'),('11','LEGAL/CORSEK',NULL),('12','FINANCE','2'),('123','CS/SC',NULL),('13','GE','2'),('14','SALES/MARKETING',NULL),('15','RX','2'),('17','MX',NULL),('2','ME/FASTEK','3'),('3','TRANSMISI','3'),('4','LOGISTIK/INVENTORY',NULL),('5','CONTENT',NULL),('6','OAB/MCR',NULL),('7','PROGRAMMING',NULL),('8','SSJ',NULL),('9','PRODUKSI',NULL);
...
insert  into `pengaduan`(`kd_pengaduan`,`username`,`judul_permasalahan`,`deskripsi`,`tanggal_pengajuan`,`status`,`kd_bagian`,`acc_pic`,`note_pic`,`tanggapan`,`tanggal_solved`,`time_solving`,`acc_kabiro`,`note_kabiro`,`solved_by`) values (2,'user1','Komputer Hangg','Sulit untuk dijelaskan bung','2016-09-13','Solved','1','accept','saya lebih bingung menjelaskan','kalem tuh','2016-09-15',2,'accept','duh mul','teknisi'),(3,'user6','Komputer Hilang','Tidak Luput Dari Dosa','2016-09-14','Solved','1','accept','Duh yah kamu ini','gsgfdsfdsdf','2016-12-16',93,'accept','Sing sabar Bung','teknisi'),(4,'user6','Komputer Rusak','Galau euy','2016-09-13','UnSolved','1',NULL,NULL,NULL,NULL,NULL,'reject','Sing bener blog',NULL),(5,'user6','Komputer meledak','gimana nih kebakaran','2016-09-15','Solved','1','accept','Sing baleg tuh blog keluhan teh','aing bisa ieu mah',NULL,NULL,'accept','sok pic kumaha','pic'),(6,'user6','Komputer Lag','aduh','2016-11-22','UnSolved','1',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(7,'user6','Komputer Matot','Kenapa komputer saya tiba-tiba mati','2017-01-01','UnSolved','10',NULL,NULL,NULL,NULL,NULL,'accept','Mati terus komputernya :(',NULL),(8,'user1','Pajak','Kenapa pajak nya sangat besar','2017-01-04','UnSolved','12',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(9,'user1','Listrik Tidak Stabil','Kenapa ini listriknya tidak stabil ya?','2017-01-04','Solved','2','accept','Tolong selesaikan','Itu harus pake stabilizer','2017-01-04',0,'accept','Kelistrikan di biro bandung mengalami permasalahan','teknisi'),(10,'user2','Lambat','Ada masalah di transmisi','2017-01-04','UnSolved','3',NULL,NULL,NULL,NULL,NULL,'accept','Permasalahan di jaringan selesaikan ya',NULL);
...
insert  into `pic`(`kd_pic`,`nama_pic`,`username`) values ('1','teknik_1','pic1'),('2','teknik_2','pic2'),('3','teknik_3','pic3'),('4','teknik_4',NULL),('5','teknik_5',NULL);

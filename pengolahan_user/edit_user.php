...
// tampilkan data
$query1 =  "SELECT  `nama`,user.username,`password`,`email`,`no_telp`,`level`,`status_akun`,`kd_biro`,`biro`,`tanggal_register` 
      ...
      <div class="widget-container fluid-height clearfix">
        ...
        <div class="widget-content padded clearfix">
            ...
            <div class="form-group">
              ...
              <div class="col-lg-8">
                  <input type="text" class="form-control" id="contract-name" placeholder="Masukan Username" name="username1" value="<?php echo $username; ?>" disabled>
              </div>
          </div>
          <div class="form-group">

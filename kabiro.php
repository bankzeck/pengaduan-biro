    ...
    $account = mysqli_fetch_array($query_akun);
     ...
     ?>
      ...
      <div class="navbar navbar-fixed-top scroll-hide">
        ...
        case 'user': $b = "current";break;
        case 'peng': $c = "current";break;
        ...
        <div class="container-fluid main-nav clearfix">
          <div class="nav-collapse">
            <ul class="nav">
              <li>
                <a class="<?php echo $a; ?>" href="kabiro.php"><span aria-hidden="true" class="icon icon-home"></span>HOME</a>
              </li>
              <li><a class="<?php echo $b; ?>" href="kabiro.php?page=list_user">
                <span aria-hidden="true" class="icon icon-user"></span>LIST USER BIRO</a>
              </li>
              <li><a class="<?php echo $c; ?>" href="kabiro.php?page=list_pengaduan">
                <span aria-hidden="true" class="icon icon-file-text"></span>LIST PENGADUAN USER BIRO</a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div class="container-fluid main-content">
        ...
        switch ($page) {
          ...
          // LIS USER 
            case 'list_user': include "kabiro/list_user.php"; break;
          // LIST PENGADUAN USER
            case 'list_pengaduan': include "kabiro/list_pengaduan_user.php"; break;
            case 'detail_pengaduan': include "kabiro/detail_pengaduan.php"; break;
            default: include 'kabiro/utama.php';
        }
        ?>
        <!-- END CONTENT -->
